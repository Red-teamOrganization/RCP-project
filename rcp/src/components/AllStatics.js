  ...
  return (
    <div>
      ...
      <div className="w-30 rounded  border-2 border-green-700">
        ...
        <h2 className="bg-red-300 p-5 text-xl text-center text-red-900 font-bold rounded-tl rounded-tr">All Proteins</h2>
        <div className="flex">
        <div className=" bg-green-600 w-40 text-center text-white p-5  rounded-bl">
        <i className="fa-brands fa-product-hunt text-xs block tracking-[0.2em]">roduction</i>
        <CountUp 
        ...
        <h2 className="bg-blue-300 p-5 text-xl text-center text-blue-900 font-bold rounded-tl rounded-tr">All Diary</h2>
        <div className="flex">
        <div className=" bg-green-600 w-40 text-center text-white p-5 rounded-bl">
        <i className="fa-brands fa-product-hunt text-xs block tracking-[0.2em]">roduction</i>
        <CountUp 
